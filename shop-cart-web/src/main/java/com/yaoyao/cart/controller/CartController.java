package com.yaoyao.cart.controller;
...
public class CartController {
	...
	public String addItemCart(@PathVariable Long itemId, @RequestParam(defaultValue = "1") Integer num,
		...
		// 把购物车列表写入cookie
		CookieUtils.setCookie(request, response, CART_KEY, JSON.toJSONString(cartItemList), CART_EXPIRE, true);
		// 返回添加成功页面
		return "cartSuccess";
	}
	...
	@ResponseBody
	public ShopResult updateItemNum(@PathVariable Long itemId, @PathVariable Integer num, HttpServletRequest request,
